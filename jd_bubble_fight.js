...
function a(t) {
  var CryptoJS = new CryptoJSs();
  var e = CryptoJS.enc.Utf8.parse('fn0chlrwxspujttbg9feqfatelupq0q1qc9ukx1ykifkco9rfqepqd4tk4ymshn0'),
    i = CryptoJS.enc.Utf8.parse(t),
    n = CryptoJS.enc.Hex.parse('00000000'),
    r = CryptoJS.TripleDES.encrypt(i, e, { iv: n });
