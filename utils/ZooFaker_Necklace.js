...
let utils = {
  ...
  atobPolyfill: function (e) {
    return (function (e) {
      ...
      for (var n, r, i, o = "", a = 0; a < e.length; )
        (n =
          (t.indexOf(e.charAt(a++)) << 18) |
          (t.indexOf(e.charAt(a++)) << 12) |
          ((r = t.indexOf(e.charAt(a++))) << 6) |
          (i = t.indexOf(e.charAt(a++)))),
          (o +=
            64 === r
  ...
  btoaPolyfill: function (e) {
    ...
    return (function (e) {
      for (
        var n, r, i, o, a = "", s = 0, u = (e = String(e)).length % 3;
        s < e.length;
  ...
  xorEncrypt: function (e, t) {
    for (var n = t.length, r = "", i = 0; i < e.length; i++)
      r += String.fromCharCode(e[i].charCodeAt() ^ t[i % n].charCodeAt());
    return r;
  },
  encrypt1: function (e, t) {
    for (
      var n = e.length, r = t.toString(), i = [], o = "", a = 0, s = 0;
      s < r.length;
      s++
    )
      a >= n && (a %= n),
        (o = (r.charCodeAt(s) ^ e.charCodeAt(a)) % 10),
        i.push(o),
        (a += 1);
  ...
  encrypt2: function (e, t) {
    ...
    return (
      r > e.length
        ? ((o = this.len_Fun(n, i)), (a = this.encrypt1(e, o)))
        : ((o = this.len_Fun(e, i)), (a = this.encrypt1(n, o))),
      a
    );
  },
  ...
  minusByByte: function (e, t) {
    var n = e.length,
      ...
      s = "",
      u = 0;
    for (n !== r && ((o = this.add0(o, i)), (a = this.add0(a, i))); u < i; )
      (s += Math.abs(o[u] - a[u])), u++;
    return s;
  },
  Crc32: function (str) {
    var table =
  ...
  objToString2: function () {
    ...
    return (
      Object.keys(e).forEach(function (n) {
        ...
        null != r &&
          (t +=
            r instanceof Object || r instanceof Array
              ? ""
                  .concat("" === t ? "" : "&")
                  .concat(n, "=")
  ...
  decipherJoyToken: function (e, t) {
    ...
    var r = "",
      ...
      o = e.length;
    if (
      (r = (r = e.slice(i, o).split(".")).map(function (e) {
    ...
    let encrypefun = {
      z: function (p1, p2) {
        ...
        for (var vi = 0; vi < p1.length; vi++) {
          str += (p1.charCodeAt(vi) ^ p2.charCodeAt(vi % p2.length)).toString(
            "16"
          );
        }
        return str;
      ...
      jiami: function (po, p1) {
        ...
        for (vi = 0; vi < po.length; vi++) {
          str += String.fromCharCode(
            po.charCodeAt(vi) ^ p1.charCodeAt(vi % p1.length)
          );
        }
  ...
  get_risk_result: async function ($) {
    ...
    var random = Math.floor(1e6 * Math.random())
      .toString()
      .padEnd(6, "8");
    ...
    data = {
      ...
      jj: 1,
      cs: hexMD5(
        "Object.P.<computed>=&HTMLDocument.Ut.<computed>=https://storage.360buyimg.com/babel/00750963/1942873/production/dev/main.e5d1c436.js"
      ),
      np: "iPhone",
      t: time,
      jk: `${$.UUID}`,
