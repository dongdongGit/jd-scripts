    ...
    (function (e, t) {
      if (e) {
        ...
        return (
          ...
          'Map' === n || 'Set' === n ? Array.from(e) : 'Arguments' === n || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n) ? encrypt_3_3(e, t) : void 0
        );
      }
    })(e) ||
    (function () {
  ...
  atobPolyfill: function (e) {
    return (function (e) {
      ...
      for (var n, r, i, o = '', a = 0; a < e.length; )
        (n = (t.indexOf(e.charAt(a++)) << 18) | (t.indexOf(e.charAt(a++)) << 12) | ((r = t.indexOf(e.charAt(a++))) << 6) | (i = t.indexOf(e.charAt(a++)))),
          (o += 64 === r ? String.fromCharCode((n >> 16) & 255) : 64 === i ? String.fromCharCode((n >> 16) & 255, (n >> 8) & 255) : String.fromCharCode((n >> 16) & 255, (n >> 8) & 255, 255 & n));
      return o;
    })(e);
  },
