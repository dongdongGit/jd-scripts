...
[task_local]
#送豆得豆
45 1,12 * * * https://raw.githubusercontent.com/LingFeng0918/jd_scripts/master/jd_senbeans.js, tag=送豆得豆, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true
================Loon==============
[Script]
cron "45 1,12 * * *" script-path=https://raw.githubusercontent.com/LingFeng0918/jd_scripts/master/jd_senbeans.js,tag=送豆得豆
===============Surge=================
送豆得豆 = type=cron,cronexp="45 1,12 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/LingFeng0918/jd_scripts/master/jd_senbeans.js
============小火箭=========
送豆得豆 = type=cron,script-path=https://raw.githubusercontent.com/LingFeng0918/jd_scripts/master/jd_senbeans.js, cronexpr="45 1,12 * * *", timeout=3600, enable=true
 */
  ...
  await new Promise((resolve) => {
    let options = {
      url: `https://draw.jdfcloud.com/common/api/bean/activity/participate?activityId=${$.activityId}&inviteUserPin=${encodeURIComponent(
        $.oneTuanInfo["user"]
      )}&invokeKey=qRKHmL4sna8ZOP9F&timestap=${Date.now()}`,
      headers: {
        "content-type": `application/json`,
        Connection: `keep-alive`,
        "Accept-Encoding": `gzip,compress,br,deflate`,
...
async function getActivityDetail() {
  const url = `https://draw.jdfcloud.com/common/api/bean/activity/detail?activityId=${
    $.activityId
  }&userOpenId=oPcgJ4_X7uCMeTgGmar-rmiWst1Y&timestap=${Date.now()}&userSource=mp&jdChannelId=&appId=wxccb5c536b0ecd1bf&invokeKey=qRKHmL4sna8ZOP9F`;
  const method = `GET`;
  const headers = {
    cookie: $.cookie,
    openId: `oPcgJ4_X7uCMeTgGmar-rmiWst1Y`,
