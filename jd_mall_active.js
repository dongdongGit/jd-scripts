...
[task_local]
#逛京东会场
0 0,20 * * * https://raw.githubusercontent.com/yongyuanlin/jd_scripts/master/jd_mall_active.js, tag=逛京东会场, enabled=true

================Loon==============
[Script]
cron "0 0,20 * * *" script-path=https://raw.githubusercontent.com/yongyuanlin/jd_scripts/master/jd_mall_active.js,tag=逛京东会场

===============Surge=================
逛京东会场 = type=cron,cronexp="0 0,20 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/yongyuanlin/jd_scripts/master/jd_mall_active.js

============小火箭=========
逛京东会场 = type=cron,script-path=https://raw.githubusercontent.com/yongyuanlin/jd_scripts/master/jd_mall_active.js, cronexpr="0 0,20 * * *", timeout=3600, enable=true
*/

const jd_env = require('./utils/JDEnv.js');
const $ = jd_env.env('逛京东会场');
...
if ($.isNode()) {
  ...
  actURL = process.env.ACT_URL || 'https://cdn.jsdelivr.net/gh/yongyuanlin/cast@main/mast/mall_active.json';
} else {
...
var r = 'NA',
  k = 'NA';
try {
  -1 != f.indexOf('win') && -1 != f.indexOf('95') && ((r = 'windows'), (k = '95')),
    -1 != f.indexOf('win') && -1 != f.indexOf('98') && ((r = 'windows'), (k = '98')),
    -1 != f.indexOf('win 9x') && -1 != f.indexOf('4.90') && ((r = 'windows'), (k = 'me')),
    -1 != f.indexOf('win') && -1 != f.indexOf('nt 5.0') && ((r = 'windows'), (k = '2000')),
    -1 != f.indexOf('win') && -1 != f.indexOf('nt') && ((r = 'windows'), (k = 'NT')),
    -1 != f.indexOf('win') && -1 != f.indexOf('nt 5.1') && ((r = 'windows'), (k = 'xp')),
    -1 != f.indexOf('win') && -1 != f.indexOf('32') && ((r = 'windows'), (k = '32')),
    -1 != f.indexOf('win') && -1 != f.indexOf('nt 5.1') && ((r = 'windows'), (k = '7')),
    -1 != f.indexOf('win') && -1 != f.indexOf('6.0') && ((r = 'windows'), (k = '8')),
    -1 == f.indexOf('win') || (-1 == f.indexOf('nt 6.0') && -1 == f.indexOf('nt 6.1')) || ((r = 'windows'), (k = '9')),
    -1 != f.indexOf('win') && -1 != f.indexOf('nt 6.2') && ((r = 'windows'), (k = '10')),
    ...
    -1 != f.indexOf('symbianos') && ((r = 'SymbianOS'), (k = f.substring(f.indexOf('SymbianOS/') + 10, 3)));
} catch (a) {}
_fingerprint_step = 3;
var g = 'NA',
  m = 'NA';
...
class JdJrTdRiskFinger {
  f = {
    ...
    pluginsKey: function (a) {
      this.isIE()
        ? (a.push(this.getIEPluginsString()), (y = y + ",'plugins':'" + t(this.getIEPluginsString()) + "'"))
    ...
    each: function (a, b, c) {
      if (null !== a)
        ...
        else if (a.length === +a.length) for (var l = 0, h = a.length; l < h && b.call(c, a[l], l, a) !== {}; l++);
        else for (l in a) if (a.hasOwnProperty(l) && b.call(c, a[l], l, a) === {}) break;
    },
    map: function (a, b, c) {
      var l = [];
      if (null == a) return l;
    ...
    x64hash128: function (a, b) {
      ...
      for (var q, z, C = [2277735313, 289559509], D = [1291169091, 658871167], B = 0; B < l; B += 16)
        (q = [
          (a.charCodeAt(B + 4) & 255) | ((a.charCodeAt(B + 5) & 255) << 8) | ((a.charCodeAt(B + 6) & 255) << 16) | ((a.charCodeAt(B + 7) & 255) << 24),
          (a.charCodeAt(B) & 255) | ((a.charCodeAt(B + 1) & 255) << 8) | ((a.charCodeAt(B + 2) & 255) << 16) | ((a.charCodeAt(B + 3) & 255) << 24),
        ]),
          (z = [
            (a.charCodeAt(B + 12) & 255) | ((a.charCodeAt(B + 13) & 255) << 8) | ((a.charCodeAt(B + 14) & 255) << 16) | ((a.charCodeAt(B + 15) & 255) << 24),
            (a.charCodeAt(B + 8) & 255) | ((a.charCodeAt(B + 9) & 255) << 8) | ((a.charCodeAt(B + 10) & 255) << 16) | ((a.charCodeAt(B + 11) & 255) << 24),
          ]),
  ...
  (function (t, u) {
    var v = {},
      ...
      A = (x.WordArray = w.extend({
        ...
        concat: function (g) {
          ...
          g = g.sigBytes;
          this.clamp();
          if (b % 4) for (var c = 0; c < g; c++) m[(b + c) >>> 2] |= ((a[c >>> 2] >>> (24 - (c % 4) * 8)) & 255) << (24 - ((b + c) % 4) * 8);
          else if (65535 < a.length) for (c = 0; c < g; c += 4) m[(b + c) >>> 2] = a[c >>> 2];
    ...
    var y = (v.enc = {}),
      n = (y.Hex = {
        ...
        parse: function (g) {
          for (var m = g.length, a = [], b = 0; b < m; b += 2) a[b >>> 3] |= parseInt(g.substr(b, 2), 16) << (24 - (b % 8) * 4);
      ...
      e = (y.Latin1 = {
        stringify: function (g) {
          var m = g.words;
          g = g.sigBytes;
          for (var a = [], b = 0; b < g; b++) a.push(String.fromCharCode((m[b >>> 2] >>> (24 - (b % 4) * 8)) & 255));
          return a.join('');
        },
        parse: function (g) {
          for (var m = g.length, a = [], b = 0; b < m; b++) a[b >>> 2] |= (g.charCodeAt(b) & 255) << (24 - (b % 4) * 8);
    ...
    _doReset: function () {
      ...
      for (var l = (this._keySchedule = []), h = 0; h < a; h++)
        if (h < c) l[h] = b[h];
          ...
          var q = l[h - 1];
          h % c
            ? 6 < c && 4 == h % c && (q = (x[q >>> 24] << 24) | (x[(q >>> 16) & 255] << 16) | (x[(q >>> 8) & 255] << 8) | x[q & 255])
            : ((q = (q << 8) | (q >>> 24)), (q = (x[q >>> 24] << 24) | (x[(q >>> 16) & 255] << 16) | (x[(q >>> 8) & 255] << 8) | x[q & 255]), (q ^= m[(h / c) | 0] << 24));
          l[h] = l[h - c] ^ q;
        }
      b = this._invKeySchedule = [];
      for (c = 0; c < a; c++) (h = a - c), (q = c % 4 ? l[h] : l[h - 4]), (b[c] = 4 > c || 4 >= h ? q : f[x[q >>> 24]] ^ r[x[(q >>> 16) & 255]] ^ k[x[(q >>> 8) & 255]] ^ g[x[q & 255]]);
    },
...
(function () {
  ...
  u = t.algo.SHA1 = x.extend({
    ...
    _doProcessBlock: function (A, y) {
      for (var n = this._hash.words, e = n[0], f = n[1], r = n[2], k = n[3], g = n[4], m = 0; 80 > m; m++) {
        if (16 > m) w[m] = A[y + m] | 0;
        else {
        ...
        a = ((e << 5) | (e >>> 27)) + g + w[m];
        a = 20 > m ? a + (((f & r) | (~f & k)) + 1518500249) : 40 > m ? a + ((f ^ r ^ k) + 1859775393) : 60 > m ? a + (((f & r) | (f & k) | (r & k)) - 1894007588) : a + ((f ^ r ^ k) - 899497514);
        g = k;
        k = r;
        r = (f << 30) | (f >>> 2);
        f = e;
...
var td_collect = new (function () {
  ...
  this.tdencrypt = function (n) {
    ...
    do {
      ...
      e =
        e +
        '23IL<N01c7KvwZO56RSTAfghiFyzWJqVabGH4PQdopUrsCuX*xeBjkltDEmn89.-'.charAt(m) +
  ...
  this.collect = function () {
    ...
    try {
      ...
      if (window.getComputedStyle)
        for (var k = 0; k < r.length; k++) document.body.appendChild(e), (e.style.color = r[k]), (f[r[k]] = window.getComputedStyle(e).getPropertyValue('color')), document.body.removeChild(e);
    } catch (D) {}
    e = {
      ca: {},
      ts: {},
    ...
    if ((k = window.WebGLRenderingContext))
      (k = navigator.userAgent), (k = k.toLowerCase()), (k = (0 < k.indexOf('jdjr-app') || 0 <= k.indexOf('jdapp')) && (0 < k.indexOf('iphone') || 0 < k.indexOf('ipad')) ? !0 : !1), (k = !k);
    if (k) {
    ...
    try {
      ...
      if (null != r && void 0 != r && '' != r)
        try {
          ...
          null != k &&
            void 0 != k.t &&
            'number' == typeof k.t &&
            (12e5 >= g - k.t && void 0 != k.tk && null != k.tk && '' != k.tk && k.tk.startsWith('jdd')
              ? ((e.deviceInfo.sdkToken = k.tk), (f = !0))
              : void 0 != k.tk && null != k.tk && '' != k.tk && (e.deviceInfo.sdkToken = k.tk));
        } catch (m) {}
      r = !1;
      e.deviceInfo.isJdApp
        ...
        : e.deviceInfo.isJrApp &&
          ((e.deviceInfo.clientVersion = navigator.userAgent.match(/clientVersion=([^&]*)(&|$)/)[1]),
...
function td_collect_exe() {
  ...
  try {
    td_collect.deviceInfo && void 0 != td_collect.deviceInfo && null != td_collect.deviceInfo.sdkToken && '' != td_collect.deviceInfo.sdkToken
