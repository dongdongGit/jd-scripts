...
let args_xh = {
   ...
   * 默认为3000，也就是3秒
   * */
  applyInterval: process.env.JD_TRY_APPLYINTERVAL * 1 || jd_helpers.randomNumber(5000, 10000),
  /*
