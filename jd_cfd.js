...
[task_local]
#京喜财富岛
18 * * * * https://raw.githubusercontent.com/yongyuanlin/jd_scripts/master/jx_cfd.js, tag=京喜财富岛, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jxcfd.png, enabled=true
================Loon==============
[Script]
cron "18 * * * *" script-path=https://raw.githubusercontent.com/yongyuanlin/jd_scripts/master/jx_cfd.js,tag=京喜财富岛
===============Surge=================
京喜财富岛 = type=cron,cronexp="18 * * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/yongyuanlin/jd_scripts/master/jd_scripts/jx_cfd.js
============小火箭=========
京喜财富岛 = type=cron,script-path=https://raw.githubusercontent.com/yongyuanlin/jd_scripts/master/jx_cfd.js, cronexpr="18 * * * *", timeout=3600, enable=true
 */
...
$.result = [];
$.shareCodes = [
  '22C6AB44CEDD7E790E22F50C1F43898BC6091C3E2FADFAF4DC532D8FC225F94E'
];
let cookiesArr = [],
  cookie = '',
  token = '';
  ...
  return new Promise(async (resolve) => {
    $.get(
      taskUrl(
        ...
        )}&strPgUUNum=${token['farm_jstoken']}&strPgtimestamp=${token['timestamp']}&strPhoneID=${token['phoneid']}`
      ),
      async (err, resp, data) => {
        try {
          if (err) {
